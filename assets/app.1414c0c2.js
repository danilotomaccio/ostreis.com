 ...
 */function $(e){return e<0?-1:e===0?0:1}function dt(e,t,r){return(1-r)*e+r*t}function Fe(e,t,r){return r<e?e:r>t?t:r}function It(e,t,r){return r<e?e:r>t?t:r}function At(e){return e=e%360,e<0&&(e=e+360),e}function Q(e){return e=e%360,e<0&&(e=e+360),e}function Ee(e,t){return Q(t-e)<=180?1:-1}function ee(e,t){return 180-Math.abs(Math.abs(e-t)-180)}function Lt(e,t){const r=e[0]*t[0][0]+e[1]*t[0][1]+e[2]*t[0][2],n=e[0]*t[1][0]+e[1]*t[1][1]+e[2]*t[1][2],a=e[0]*t[2][0]+e[1]*t[2][1]+e[2]*t[2][2];return[r,n,a]}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const re=[[.41233895,.35762064,.18051042],[.2126,.7152,.0722],[.01932141,.11916382,.95034478]],Oe=[[3.2413774792388685,-1.5376652402851851,-.49885366846268053],[-.9691452513005321,1.8758853451067872,.04156585616912061],[.05562093689691305,-.20395524564742123,1.0571799111220335]],Ut=[95.047,100,108.883];function Tt(e,t,r){return(255<<24|(e&255)<<16|(t&255)<<8|r&255)>>>0}function Zt(e){const t=ct(e[0]),r=ct(e[1]),n=ct(e[2]);return Tt(t,r,n)}function ve(e){return e>>24&255}function Dt(e){return e>>16&255}function xt(e){return e>>8&255}function Bt(e){return e&255}function ne(e,t,r){const n=Oe,a=n[0][0]*e+n[0][1]*t+n[0][2]*r,s=n[1][0]*e+n[1][1]*t+n[1][2]*r,o=n[2][0]*e+n[2][1]*t+n[2][2]*r,c=ct(a),h=ct(s),f=ct(o);return Tt(c,h,f)}function Le(e){const t=tt(Dt(e)),r=tt(xt(e)),n=tt(Bt(e));return Lt([t,r,n],re)}function Se(e,t,r){const n=Ut,a=(e+16)/116,s=t/500+a,o=a-r/200,c=kt(s),h=kt(a),f=kt(o),l=c*n[0],d=h*n[1],g=f*n[2];return ne(l,d,g)}function ae(e){const t=tt(Dt(e)),r=tt(xt(e)),n=tt(Bt(e)),a=re,s=a[0][0]*t+a[0][1]*r+a[0][2]*n,o=a[1][0]*t+a[1][1]*r+a[1][2]*n,c=a[2][0]*t+a[2][1]*r+a[2][2]*n,h=Ut,f=s/h[0],l=o/h[1],d=c/h[2],g=pt(f),m=pt(l),p=pt(d),u=116*m-16,b=500*(g-m),A=200*(m-p);return[u,b,A]}function He(e){const t=rt(e),r=ct(t);return Tt(r,r,r)}function St(e){const t=Le(e)[1];return 116*pt(t/100)-16}function rt(e){return 100*kt((e+16)/116)}function Ht(e){return pt(e/100)*116-16}function tt(e){const t=e/255;return t<=.040449936?t/12.92*100:Math.pow((t+.055)/1.055,2.4)*100}function ct(e){const t=e/100;let r=0;return t<=.0031308?r=t*12.92:r=1.055*Math.pow(t,1/2.4)-.055,Fe(0,255,Math.round(r*255))}function Ne(){return Ut}function pt(e){const t=.008856451679035631,r=24389/27;return e>t?Math.pow(e,1/3):(r*e+16)/116}function kt(e){const t=.008856451679035631,r=24389/27,n=e*e*e;return n>t?n:(116*e-16)/r}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{fromInt(t){return ae(t)}toInt(t){return Se(t[0],t[1],t[2])}distance(t,r){const n=t[0]-r[0],a=t[1]-r[1],s=t[2]-r[2];return n*n+a*a+s*s}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{static quantize(t){const r=new Map;for(let n=0;n<t.length;n++){const a=t[n];ve(a)<255||r.set(a,(r.get(a)??0)+1)}return r}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{static quantize(t,r){const a=new Ye().quantize(t,r);return qe.quantize(t,a,r)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe extends lt{constructor(t,r,n){super({sourceColorArgb:t.toInt(),variant:ot.CONTENT,contrastLevel:n,isDark:r,primaryPalette:x.fromHueAndChroma(t.hue,t.chroma),secondaryPalette:x.fromHueAndChroma(t.hue,Math.max(t.chroma-32,t.chroma*.5)),tertiaryPalette:x.fromInt(_t.fixIfDisliked(new gt(t).analogous(3,6)[2]).toInt()),neutralPalette:x.fromHueAndChroma(t.hue,t.chroma/8),neutralVariantPalette:x.fromHueAndChroma(t.hue,t.chroma/8+4)})}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt extends lt{constructor(t,r,n){super({sourceColorArgb:t.toInt(),variant:ot.EXPRESSIVE,contrastLevel:n,isDark:r,primaryPalette:x.fromHueAndChroma(Q(t.hue+240),40),secondaryPalette:x.fromHueAndChroma(lt.getRotatedHue(t,nt.hues,nt.secondaryRotations),24),tertiaryPalette:x.fromHueAndChroma(lt.getRotatedHue(t,nt.hues,nt.tertiaryRotations),32),neutralPalette:x.fromHueAndChroma(t.hue+15,8),neutralVariantPalette:x.fromHueAndChroma(t.hue+15,12)})}}nt.hues=[0,21,51,121,151,191,271,321,360];nt.secondaryRotations=[45,95,45,20,45,90,45,45,45];nt.tertiaryRotations=[120,120,20,45,20,15,20,120,120];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tr={desired:4,fallbackColorARGB:4282549748,filter:!0};function er(e,t){return e.score>t.score?-1:e.score<t.score?1:0}class G{constructor(){}static score(t,r){const{desired:n,fallbackColorARGB:a,filter:s}={...tr,...r},o=[],c=new Array(360).fill(0);let h=0;for(const[m,p]of t.entries()){const u=F.fromInt(m);o.push(u);const b=Math.floor(u.hue);c[b]+=p,h+=p}const f=new Array(360).fill(0);for(let m=0;m<360;m++){const p=c[m]/h;for(let u=m-14;u<m+16;u++){const b=At(u);f[b]+=p}}const l=new Array;for(const m of o){const p=At(Math.round(m.hue)),u=f[p];if(s&&(m.chroma<G.CUTOFF_CHROMA||u<=G.CUTOFF_EXCITED_PROPORTION))continue;const b=u*100*G.WEIGHT_PROPORTION,A=m.chroma<G.TARGET_CHROMA?G.WEIGHT_CHROMA_BELOW:G.WEIGHT_CHROMA_ABOVE,y=(m.chroma-G.TARGET_CHROMA)*A,M=b+y;l.push({hct:m,score:M})}l.sort(er);const d=[];for(let m=90;m>=15;m--){d.length=0;for(const{hct:p}of l)if(d.find(b=>ee(p.hue,b.hue)<m)||d.push(p),d.length>=n)break;if(d.length>=n)break}const g=[];d.length===0&&g.push(a);for(const m of d)g.push(m.toInt());return g}}G.TARGET_CHROMA=48;G.WEIGHT_PROPORTION=.7;G.WEIGHT_CHROMA_ABOVE=.3;G.WEIGHT_CHROMA_BELOW=.1;G.CUTOFF_CHROMA=5;G.CUTOFF_EXCITED_PROPORTION=.01;/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(e){const t=Dt(e),r=xt(e),n=Bt(e),a=[t.toString(16),r.toString(16),n.toString(16)];for(const[s,o]of a.entries())o.length===1&&(a[s]="0"+o);return"#"+a.join("")}function rr(e){e=e.replace("#","");const t=e.length===3,r=e.length===6,n=e.length===8;if(!t&&!r&&!n)throw new Error("unexpected hex "+e);let a=0,s=0,o=0;return t?(a=X(e.slice(0,1).repeat(2)),s=X(e.slice(1,2).repeat(2)),o=X(e.slice(2,3).repeat(2))):r?(a=X(e.slice(0,2)),s=X(e.slice(2,4)),o=X(e.slice(4,6))):n&&(a=X(e.slice(2,4)),s=X(e.slice(4,6)),o=X(e.slice(6,8))),(255<<24|(a&255)<<16|(s&255)<<8|o&255)>>>0}function X(e){return parseInt(e,16)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ar(e,t=[]){const r=H.of(e);return{source:e,schemes:{light:K.light(e),dark:K.dark(e)},palettes:{primary:r.a1,secondary:r.a2,tertiary:r.a3,neutral:r.n1,neutralVariant:r.n2,error:r.error},customColors:t.map(n=>or(e,n))}}async function sr(e,t=[]){const r=await nr(e);return ar(r,t)}function or(e,t){let r=t.value;const n=r,a=e;t.blend&&(r=qt.harmonize(n,a));const o=H.of(r).a1;return{color:t,value:r,light:{color:o.tone(40),onColor:o.tone(100),colorContainer:o.tone(90),onColorContainer:o.tone(10)},dark:{color:o.tone(80),onColor:o.tone(20),colorContainer:o.tone(30),onColorContainer:o.tone(90)}}}const ir={background:i.background,"on-background":i.onBackground,surface:i.surface,"surface-dim":i.surfaceDim,"surface-bright":i.surfaceBright,"surface-container-lowest":i.surfaceContainerLowest,"surface-container-low":i.surfaceContainerLow,"surface-container":i.surfaceContainer,"surface-container-high":i.surfaceContainerHigh,"surface-container-highest":i.surfaceContainerHighest,"on-surface":i.onSurface,"surface-variant":i.surfaceVariant,"on-surface-variant":i.onSurfaceVariant,"inverse-surface":i.inverseSurface,"inverse-on-surface":i.inverseOnSurface,outline:i.outline,"outline-variant":i.outlineVariant,shadow:i.shadow,scrim:i.scrim,"surface-tint":i.surfaceTint,primary:i.primary,"on-primary":i.onPrimary,"primary-container":i.primaryContainer,"on-primary-container":i.onPrimaryContainer,"inverse-primary":i.inversePrimary,secondary:i.secondary,"on-secondary":i.onSecondary,"secondary-container":i.secondaryContainer,"on-secondary-container":i.onSecondaryContainer,tertiary:i.tertiary,"on-tertiary":i.onTertiary,"tertiary-container":i.tertiaryContainer,"on-tertiary-container":i.onTertiaryContainer,error:i.error,"on-error":i.onError,"error-container":i.errorContainer,"on-error-container":i.onErrorContainer};function Nt(e,t){const r=new Qe(F.fromInt(rr(e)),t,0),n={};for(const[a,s]of Object.entries(ir))n[a]=se(s.getArgb(r));return n}function zt(e,t,r="material-theme"){let n=":root,:host{";for(const[a,s]of Object.entries(t))n+=`--md-sys-color-${a}:${s};`;n+="}",cr(e,n,r)}function cr(e,t,r="material-theme"){let n=globalThis[r];n||(n=new CSSStyleSheet,globalThis[r]=n,e.adoptedStyleSheets.push(n)),n.replaceSync(t),localStorage.setItem(r,t)}let wt;async function oe(e,t=!1){const r=await sr(e);wt=se(r.source);const n=Nt(wt,t);zt(document,n)}const lr=e=>{e.matches?zt(document,Nt(wt,!0)):zt(document,Nt(wt,!1))},hr=["href"],ur={class:"text"},fr={class:"title display-large"},mr={key:0,class:"subtitle"},dr={class:"date"},pr={class:"img"},gr=["src"],yr=ht({__name:"BannerArticle",props:{img:{},title:{},subtitle:{},date:{},url:{}},setup(e){const t=e,r=Qt(),n=window.matchMedia("(prefers-color-scheme: dark)");Gt(()=>oe(r.value,n.matches));const a=lr;return n.addEventListener("change",a),fe(()=>n.removeEventListener("change",a)),(s,o)=>(j(),J("a",{href:t.url,id:"banner"},[L("div",ur,[L("div",fr,st(t.title),1),t.subtitle?(j(),J("div",mr,st(t.subtitle),1)):te("",!0),L("div",dr,st(new Date(t.date).toDateString()),1)]),L("div",pr,[L("img",{ref_key:"image",ref:r,src:t.img},null,8,gr)])],8,hr))}});const Pr=Vt(yr,[["__scopeId","data-v-97b19982"]]),Mr=["href"],Cr={class:"text"},br={class:"title display-medium"},kr={key:0,class:"subtitle"},Ir={class:"date"},Ar={class:"img"},wr=["src"],Tr=ht({__name:"ArticlePrev",props:{article:{}},setup(e){const t=e;return(r,n)=>(j(),J("a",{href:t.article.url,class:"article"},[L("div",Cr,[L("div",br,st(t.article.frontmatter.title),1),t.article.frontmatter.subtitle?(j(),J("div",kr,st(t.article.frontmatter.subtitle),1)):te("",!0),L("div",Ir,st(new Date(t.article.frontmatter.date).toDateString()),1)]),L("div",Ar,[L("img",{src:t.article.frontmatter.img},null,8,wr)])],8,Mr))}});const Dr=Vt(Tr,[["__scopeId","data-v-1ca0f4e3"]]),xr={class:"articles"},Br={class:"row"},_r=ht({__name:"Articles",props:{articles:{}},setup(e){const t=e;t.articles.shift();const r=[];for(let n=0;n<t.articles.length;n+=2)r.push([t.articles[n],...n+1<t.articles.length?[t.articles[n+1]]:[]]);return(n,a)=>(j(),J("div",xr,[(j(),J(Xt,null,Kt(r,s=>L("div",Br,[(j(!0),J(Xt,null,Kt(s,o=>(j(),me(Dr,{article:o},null,8,["article"]))),256))])),64))]))}});const Rr=Vt(_r,[["__scopeId","data-v-746579e3"]]),Fr=ht({__name:"Home",setup(e){const t=Re.sort((n,a)=>(new Date(n.frontmatter.date).getTime()-new Date(a.frontmatter.date).getTime())*-1),r=t[0];return(n,a)=>(j(),J("div",null,[yt(Pr,{url:Z(r).url,img:Z(r).frontmatter.img,title:Z(r).frontmatter.title,date:Z(r).frontmatter.date},null,8,["url","img","title","date"]),yt(Rr,{articles:[...Z(t)]},null,8,["articles"])]))}}),Er={class:"banner"},Or={class:"text"},vr={class:"display-large title"},Lr={class:"date"},Sr={class:"img"},Hr=["src"],Nr=ht({__name:"Article",setup(e){const t=$t(),r=Qt();return Gt(()=>oe(r.value)),(n,a)=>{const s=de("Content");return j(),J("div",null,[L("div",Er,[L("div",Or,[L("div",vr,st(Z(t).frontmatter.value.title),1),L("div",Lr,st(new Date(Z(t).frontmatter.value.date).toDateString()),1)]),L("div",Sr,[L("img",{ref_key:"image",ref:r,src:Z(t).frontmatter.value.img},null,8,Hr)])]),L("div",null,[yt(s,{class:"content"})])])}}});const zr={key:0},Gr={key:1},Vr=ht({__name:"Layout",setup(e){const{site:t,frontmatter:r}=$t();return(n,a)=>Z(r).home?(j(),J("div",zr,[yt(Fr)])):(j(),J("div",Gr,[yt(Nr)]))}});const $r={Layout:Vr,enhanceApp({app:e,router:t,siteData:r}){}};function ie(e){if(e.extends){const t=ie(e.extends);return{...t,...e,async enhanceApp(r){t.enhanceApp&&await t.enhanceApp(r),e.enhanceApp&&await e.enhanceApp(r)}}}return e}const ut=ie($r),Ur=ht({name:"VitePressApp",setup(){const{site:e}=$t();return Gt(()=>{Te(()=>{document.documentElement.lang=e.value.lang,document.documentElement.dir=e.value.dir})}),De(),xe(),Be(),ut.setup&&ut.setup(),()=>_e(ut.Layout)}});async function qr(){const e=Wr(),t=jr();t.provide(ge,e);const r=ye(e.route);return t.provide(Pe,r),t.component("Content",Me),t.component("ClientOnly",Ce),Object.defineProperties(t.config.globalProperties,{$frontmatter:{get(){return r.frontmatter.value}},$params:{get(){return r.page.value.params}}}),ut.enhanceApp&&await ut.enhanceApp({app:t,router:e,siteData:be}),{app:t,router:e,data:r}}function jr(){return ke(Ur)}function Wr(){let e=vt,t;return Ie(r=>{let n=Ae(r),a=null;return n&&(e&&(t=n),(e||t===n)&&(n=n.replace(/\.js$/,".lean.js")),a=we(()=>import(n),[])),vt&&(e=!1),a},ut.NotFound)}vt&&qr().then(({app:e,router:t,data:r})=>{t.go().then(()=>{pe(t.route,r.site),e.mount("#app")})});export{qr as createApp};
